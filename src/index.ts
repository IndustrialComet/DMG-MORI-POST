import { CAPABILITY } from "./types/constant";
import {CONSTANT,Vector,Matrix} from "./types/index";
/**
...
function setCoolant(coolant: CONSTANT.COOLANT) {
...
function onCommand(command: CONSTANT.COMMAND) {
	switch (command) {
		case 1:

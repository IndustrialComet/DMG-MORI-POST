...
export enum RADIUS_COMPENSATION {
...
declare const COMMAND_INVALID: COMMAND;//Invalid (well-known COMMAND).
declare const COMMAND_STOP: COMMAND;//Program stop (well-known COMMAND M00).
declare const COMMAND_OPTIONAL_STOP: COMMAND;//Optional program stop (well-known COMMAND M01).
declare const COMMAND_END: COMMAND;//Program end (well-known COMMAND M02).
declare const COMMAND_SPINDLE_CLOCKWISE: COMMAND;//Clockwise spindle direction (well-known COMMAND M03).
declare const COMMAND_SPINDLE_COUNTERCLOCKWISE: COMMAND;//Counterclockwise spidle direction (well-known COMMAND M04).
declare const COMMAND_START_SPINDLE: COMMAND 
declare const COMMAND_STOP_SPINDLE: COMMAND;//Spindle stop (well-known COMMAND M05).
declare const COMMAND_ORIENTATE_SPINDLE: COMMAND 
declare const COMMAND_LOAD_TOOL: COMMAND;//Tool change (M06).
declare const COMMAND_COOLANT_ON: COMMAND;//Coolant on (M08).
declare const COMMAND_COOLANT_OFF: COMMAND;//Coolant off (M09).
declare const COMMAND_ACTIVATE_SPEED_FEED_SYNCHRONIZATION: COMMAND;//Activate speed-feed synchronization (well-known COMMAND).
declare const COMMAND_DEACTIVATE_SPEED_FEED_SYNCHRONIZATION: COMMAND;//Deactivate speed-feed synchronization (well-known COMMAND).
declare const COMMAND_LOCK_MULTI_AXIS: COMMAND;//Locks the 4th and 5th axes. This COMMAND is optional.
declare const COMMAND_UNLOCK_MULTI_AXIS: COMMAND;//Unlocks the 4th and 5th axes. This COMMAND is optional.
declare const COMMAND_EXACT_STOP: COMMAND;//Exact stop. This COMMAND is optional.
declare const COMMAND_START_CHIP_TRANSPORT: COMMAND;//Close chip transport.
declare const COMMAND_STOP_CHIP_TRANSPORT: COMMAND;//Stop chip transport.
declare const COMMAND_OPEN_DOOR: COMMAND;//Open primary door.
declare const COMMAND_CLOSE_DOOR: COMMAND;//Close primary door.
declare const COMMAND_BREAK_CONTROL: COMMAND;//Break control.
declare const COMMAND_TOOL_MEASURE: COMMAND;//Measure tool.
declare const COMMAND_CALIBRATE: COMMAND;//Run calibration cycle.
declare const COMMAND_VERIFY: COMMAND;//Verify part/tool/machine integrity.
declare const COMMAND_CLEAN: COMMAND;//Run cleaning cycle.
declare const COMMAND_ALARM: COMMAND;//Alarm.
declare const COMMAND_ALERT: COMMAND;//Alert.
declare const COMMAND_CHANGE_PALLET: COMMAND;//Change pallet.
declare const COMMAND_POWER_ON: COMMAND;//Power on.
declare const COMMAND_POWER_OFF: COMMAND;//Power off.
declare const COMMAND_MAIN_CHUCK_OPEN: COMMAND;//Open main chuck. More...
declare const COMMAND_MAIN_CHUCK_CLOSE: COMMAND;//Close main chuck. More...
declare const COMMAND_SECONDARY_CHUCK_OPEN: COMMAND;//Open secondary chuck. More...
declare const COMMAND_SECONDARY_CHUCK_CLOSE: COMMAND;//Close secondary chuck. More...
declare const COMMAND_SECONDARY_SPINDLE_SYNCHRONIZATION_ACTIVATE: COMMAND;//Activate spindle synchronization. More...
declare const COMMAND_SECONDARY_SPINDLE_SYNCHRONIZATION_DEACTIVATE: COMMAND;//Deactivate spindle synchronization. More...
declare const COMMAND_SYNC_CHANNELS: COMMAND;//Sync channels.
declare const COMMAND_PROBE_ON: COMMAND;//Probe on.
declare const COMMAND_PROBE_OFF: COMMAND;//Probe off.
